...
# Zero out specified frequency range
...
wavfile.write('denoised_audio_output.wav', sample_rate, filtered_data)

print("Denoised audio saved as 'denoised_audio_output.wav'")
